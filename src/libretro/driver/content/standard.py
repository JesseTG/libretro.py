...
from .driver import ContentDriver, LoadedContentFile, ContentAttributes, ContentError, LoadedContent
        ...
        with ExitStack() as stack:
            ...
            match content:
                case SubsystemContent(game_type=game_type, info=info):
                    ...
                    c: Content
                    loaded_content = [
                        stack.enter_context(self._load(c, subsystem, subsystem[i])) for (i, c) in enumerate(info)
                    ]
