...
class GeneratorInputDriver(InputDriver):
    def __init__(
        ...
        self._input_generator_state: Iterator[InputPollResult | Sequence[InputPollResult]] | None = None
    ...
    def _lookup_port_state(self, result: InputPollResult, device: InputDevice, index: int, id: int) -> int:
        match (result, device, index, id):
            ...
            # with all other devices defaulting to 0.
            case AnalogState() as analog_state, InputDevice.ANALOG, DeviceIndexAnalog.BUTTON, id:
                analog_state: AnalogState
                return analog_state[id]
            case AnalogState() as analog_state, InputDevice.ANALOG, DeviceIndexAnalog.LEFT, id if id in DeviceIdAnalog:
                analog_state: AnalogState
                return analog_state.lstick[id]
            case AnalogState() as analog_state, InputDevice.ANALOG, DeviceIndexAnalog.RIGHT, id if id in DeviceIdAnalog:
                analog_state: AnalogState
